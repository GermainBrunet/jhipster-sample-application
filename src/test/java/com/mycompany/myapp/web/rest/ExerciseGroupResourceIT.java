...
public class ExerciseGroupResourceIT {
    ...
    public void createExerciseGroup() throws Exception {
        ...
        assertThat(testExerciseGroup.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testExerciseGroup.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    ...
    public void checkSortOrderIsRequired() throws Exception {
        int databaseSizeBeforeTest = exerciseGroupRepository.findAll().size();
        // set the field null
        exerciseGroup.setSortOrder(null);
    ...
    public void updateExerciseGroup() throws Exception {
        ...
        assertThat(testExerciseGroup.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testExerciseGroup.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
