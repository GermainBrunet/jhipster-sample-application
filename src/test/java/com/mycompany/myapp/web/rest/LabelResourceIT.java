...
public class LabelResourceIT {
    ...
    public void createLabel() throws Exception {
        ...
        assertThat(testLabel.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
        assertThat(testLabel.getCode()).isEqualTo(DEFAULT_CODE);
    }
    ...
    public void updateLabel() throws Exception {
        ...
        Label testLabel = labelList.get(labelList.size() - 1);
        assertThat(testLabel.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
        assertThat(testLabel.getCode()).isEqualTo(UPDATED_CODE);
    }
