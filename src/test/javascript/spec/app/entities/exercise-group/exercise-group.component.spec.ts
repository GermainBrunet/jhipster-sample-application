...
import { ExerciseGroupComponent } from 'app/entities/exercise-group/exercise-group.component';
...
describe('Component Tests', () => {
  describe('ExerciseGroup Management Component', () => {
    let comp: ExerciseGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ExerciseGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.exerciseGroups && comp.exerciseGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
