...
public class Label implements Serializable {
    ...
    public ExerciseGroup getGuid() {
        return guid;
    }

    public Label guid(ExerciseGroup exerciseGroup) {
        this.guid = exerciseGroup;
        return this;
    }

    public void setGuid(ExerciseGroup exerciseGroup) {
        this.guid = exerciseGroup;
    }
