...
public interface LabelService {
    ...
    /**
     * Get all the LabelDTO where Keyword is {@code null}.
     *
     * @return the list of entities.
     */
    List<LabelDTO> findAllWhereKeywordIsNull();
    /**
     * Get all the LabelDTO where Level is {@code null}.
     *
     * @return the list of entities.
     */
    List<LabelDTO> findAllWhereLevelIsNull();
